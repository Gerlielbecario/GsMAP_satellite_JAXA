...
def read_gsmap_subset( my_file , lon_min , lon_max , lat_min , lat_max ) :
   ...
   #Se agrego un +1 para extraer el ultimo valor final inicio:final+1 , es distinto al codigo de juan
   sqpe_subset=sqpe[ index_lat.min():index_lat.max() +1  , index_lon.min():index_lon.max() +1 ]
